  ...
  return (
    <section className="about__section">
      <article className="about__div-big">
        ...
        <p>
          소비자들의 어려움을 해결하기 위해 친환경에 반한 바나나가 사용하는
          새로운 기준이 바로 바나나 인덱스입니다.
          <br />
          바나나 인덱스는 세계적인 잡지사 Economist에서 제안한 바나나 1kg을
          기준으로 다른 식품들의 상대적인 탄소배출량을 비교한 지표입니다.
          <br />
          식품별로 바나나와 비교했을 때 얼마만큼의 탄소를 소비하는지 쉽게 파악할
          수 있는 기준이 됩니다.
          <br />
      ...
      <article className="about__div-graph">
